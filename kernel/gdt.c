...
// kernel segments
#define GDT_CODE0 \
    GDT_PRES(1) | GDT_PRIV(0) | GDT_ONE | GDT_EXEC(1) | GDT_RDWR(1)
#define GDT_DATA0 \
    GDT_PRES(1) | GDT_PRIV(0) | GDT_ONE | GDT_EXEC(0) | GDT_RDWR(1)

// user segments
#define GDT_CODE3 \
    GDT_PRES(1) | GDT_PRIV(3) | GDT_ONE | GDT_EXEC(1) | GDT_RDWR(1)
#define GDT_DATA3 \
    GDT_PRES(1) | GDT_PRIV(3) | GDT_ONE | GDT_EXEC(0) | GDT_RDWR(1)
